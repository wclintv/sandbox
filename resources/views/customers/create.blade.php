    	...
    	<div class="col-md-8 col-md-offset-2">
    		<div class="panel panel-default panel-h-offset">
    			<div id="panel-body" class="panel-body panel-body-overflow">
    				<customer-create ref="vue_template"></customer-create>
    			</div>						
    		</div>
    	</div>
    </div>
    ...
    <div class="flex-center footer-content">
        <span>  
            <form method="GET" class="no-padding">                          
                <input class="btn btn-default btn-panel-header" style="margin-right:10px;" type="submit" value="Cancel" formaction="/customers" />
            </form>                         
        </span>    
    	<span>
    		<button id="btn_create" class="btn btn-primary btn-panel-header">Create</button>
    	</span>
    </div>
@endsection
@push('scripts')
    <template id="customer-create">
    ...
    <script>
        ...
        var customer_create = Vue.extend({
            ...
            methods: {
                ...
                customerCreate: function(){
                    ...
                    this.$http.post(endpoint, this.customer).then(function(response){
                        console.log('create successful.');
                        $("#popup_loader").modal('toggle');
                        window.location.href = "/customers/" + response.body.cust_id;
                    }, function(response){
        ...
        document.getElementById("btn_create").onclick = function () {
            vm.$refs.vue_template.customerCreate();
        };
    </script>
@endpush
